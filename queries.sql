...
VALUES ('1', '3', 'Собеседование в IT компании', 0, '2021.08.03',null),
       ('1', '3', 'Выполнить тестовое задание', 0, '2021.12.25',null),
       ('1', '2', 'Сделать задание первого раздела', 1, '2021.07.02',null),
       ('1', '1', 'Встреча с другом', 0, '2021.09.22',null),
       ('1', '4', 'Купить корм для кота', 0, null, null),
       ('1', '4', 'Заказать пиццу', 0, null, null);
